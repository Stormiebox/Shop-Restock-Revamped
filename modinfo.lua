...
meta =
{
    ...
    name = "Shop Restock Revamped",

    -- Title of your mod that will be displayed to players
    title = "Shop Restock Revamped",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "A revamped version of the original Shop Restock Button mod.",
    ...
    contact = "My Discord: stormbox - I am also in the official Avorion Discord!",
}
